...
<?php
    ...
    $objUn = new Unidades_Tematicas();

    $dataUnidades = $objUn->getAllUnidades();
            ...
            <form id="formCapitulo">
                <div class="container">
                    <div class="row bg-light p-1">
                                <div class="col">
                                    <label  class="form-label">Unidad tematica al que pertenece </label>
                                    <select type="text" class="form-control"  name="id_unidad_tematica">

                                    <option value="" selected>Elige la unidad</option>
                                    <?php   
                                        foreach ($dataUnidades as $key ) {
