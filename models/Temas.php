...
class Temas{
    ...
    public function postDataTema($data){
        $delimiter = ':';
        echo var_dump($data);
    ...
    public function getTemasByCapitulos($id){
        $sql = "SELECT * FROM temas WHERE id_capitulo = :id_capitulo";
        $stmt = self::$conn->prepare($sql);
    ...
    public function updateTemaById($data,$id){
        $delimiter = ",:";
        $cont = 1;
    ...
    public function delTemaById($id){
        $RESPONSE=[];
